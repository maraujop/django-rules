...
This command will look for all your <code>rules.py</code> files under your <code>INSTALLED_APPS</code> and sync the Database with the last changes, so you don't have to run <code>syncdb</code> or drop the database before.
